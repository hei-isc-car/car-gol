...
The firmware selects a GPIO layout at compile time with Cargo features:

- `board-lcdkit`: ESP32-C3-LCDkit layout
- `board-devkit-rust-2`: ESP32-C3-DevKit-Rust-2 layout

The board-specific GPIO numbers and peripheral notes live in `src/bin/runtime/board.rs`.
